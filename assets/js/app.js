...
function pgAbout(){
 ...
 <section class="blk"><div class="wrap">
   ...
   <p class="slead">부스는 행사장 바깥 테두리를 따라 단열로 배치합니다. 부스에 앉아서도 무대가 보이도록 한 구성입니다.</p>
   <div class="imgbox" style="margin-top:26px"><img src="${IMG_LAYOUT}" alt="제21회 연어 행사장 배치도"></div>
   <p class="cap">배치도 v3 · 문화재 현상변경 허가 신청 기준. 세부 배치는 현장 답사와 허가 결과에 따라 조정될 수 있습니다.</p>
 </div></section>
...
function pgProgram(tab){
 ...
 if(T==="market"){
  body=`
   ...
   <div class="imgbox" style="margin-top:28px"><img src="${IMG_LAYOUT}" alt="아트마켓 배치도"></div>
   <p class="cap">배치도 v3 — 부스를 마주보게 두지 않고, 행사장 바깥 테두리를 따라 단열로 배치했습니다.</p>
